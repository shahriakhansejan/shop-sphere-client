...
import { useAddBookmarkMutation, useGetAProductQuery } from "../redux/feature/allProduct/allProductApi";
      ...
      <div className="hero bg-base-200 min-h-screen">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <button className="btn btn-outline"><CiShoppingTag />Buy</button>
            <button onClick={()=>addBookmark(product)} className="btn btn-outline"><CiBookmarkPlus />Bookmark</button>
            </div>
            ...
            <button onClick={()=> navigate(-1)} className="btn btn-active mt-10"><FaBackward />Back</button>
            </div>
          </div>
        </div>
      </div>
